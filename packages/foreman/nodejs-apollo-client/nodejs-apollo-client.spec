...
Source0: https://registry.npmjs.org/@apollo/client/-/client-3.13.9.tgz
...
Provides: bundled(npm(@apollo/client)) = 3.13.9
...
%changelog
* Mon Aug 11 2025 Foreman Packaging Automation <packaging@theforeman.org> 3.13.9-1
- Update to 3.13.9
